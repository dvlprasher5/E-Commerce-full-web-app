      ...
      <div className="flex flex-col md:grid md:grid-cols-12 md:gap-sides min-h-max">
        ...
        <div className="flex sticky top-0 flex-col col-span-5 2xl:col-span-4 max-md:col-span-full md:h-screen min-h-max max-md:p-sides md:pl-sides md:pt-top-spacing max-md:static">
          <div className="col-span-full">
            ...
            <div className="flex flex-col col-span-full gap-4 mb-10 max-md:order-2">
              <div className="flex flex-col grid-cols-2 px-3 py-2 rounded bg-popover md:grid md:gap-x-4 md:gap-y-10 place-items-baseline">
          ...
          <Prose
            className="col-span-full mb-auto opacity-70 max-md:order-3 max-md:mt-6"
