...
export function FeaturedProductLabel({
  ...
  return (
    <div className={cn('flex gap-2 items-center p-2 pl-8 bg-white rounded-md w-fit', className)}>
      <div className="pr-6 leading-4">
        <Link href={`/product/${product.handle}`} className="inline-flex text-base font-semibold opacity-80 mb-1.5">
          {product.title}
        </Link>
